...
$getFluxPersoSupp = $profil->getFluxPersoSupp($_COOKIE['userid']);
	...
	<div id="banniere">
		...
		<div id="profil_info">
			...
			<ul>
				...
				<a href="profil.php" title="Liste de flux Actuel"><li>Liste de flux actuel<br><span><?php foreach($countFluxAct as $v){ echo $v[0]; } ?></span></li></a>
		...
		<div id="conteneur_profil_user">
			...
			<div id="affichage_user">
				<ul>
					<li>Tout vos flux supprimées</li>
				</ul>
				<?php foreach($getFluxPersoSupp[0] as $v) { ?>
					<div id="news">
			...
			<div id="pagination">
				<p><?php echo $getFluxPersoSupp[1]; ?></p>
			</div>
		</div>
</div>
</body>
