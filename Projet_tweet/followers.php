...
<?php } ?>
<td><a class="publie" style="background:<?php echo $couleurBackground; ?>"  href="">Tweeter</a></td>
...
<div style="background:<?php echo "#3B94D9"; ?>" class="banniere"> <?php }else { foreach($selectThemeUser as $v5){ ?> <div style="background:<?php echo $v5['th_color']; ?>" class="banniere">  <?php } }  ?>
...
<div id="conteneur">
	<div class="profil_left">
		<div id="theme_color">
	<form class="noneform" action="followers.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
	<input type="file" name="avatar" id="avatar" value="<?php echo $v['type']; ?>"/>
		...
		<input type="submit" id="confirmer" name="confirmer1" />
		<p>Annuler</p>
	</form>
	</div>
...
<input type="submit" style="background:<?php echo $couleurBackground; ?>"  name="suivre" value="suivre" id="suivre">
</form>
</div>
...
<?php foreach ($GetFollowUser as $v5) { ?>
<div class="abonnees">
<div class="topabo">

</div>
<img src="up/<?php echo $v5['type']; ?>" width="70" height="70" alt="photo_profil">
<form action="following.php?id=<?php echo $_GET['id']; ?>" method="post">
<input type="submit" name="desabo" style="background:<?php echo $couleurBackground; ?>"  value="Abonné" class="abo">

</form>
<br>
<p class="nameabo"><?php echo $v5['fullname']; ?></p>
<span><?php echo "@" . $v5['login']; ?></span>
<p class="description_abo">Description</p>
