...
<body id="un">
	...
	<div id="barreAbo">
		<div id="centerbarre">
			...
			<ul>
				<?php foreach($countTweet as $v1) { ?><a href=""><li><p>TWEETS</p><p><?php echo $v1[0]; ?></p></li></a> <?php } ?>
				<?php foreach($countFollow as $v2) { ?><a href=""><li><p>ABONNEMENTS</p><p><?php echo $v2[0]; ?></p></li></a> <?php } ?>
	...
	<div id="conteneur">
		...
		<div class="profilcontenu">
			...
			<div class="suggest">
				<p class="align"><img class="lol4" src="up/<?php echo $v2['type']; ?>" class="avatar2" width="49"  height="49"  alt="avatar" /></p><p class="haut"><a href="" class="focusprofil"><?php echo $v2['login']; ?></a><span class="petit"> @<?php echo  $v2['login'] ?></span></p>
